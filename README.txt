...
70、我们来指定一下"营养素摄入"的子页面的内容。我要求有三个区块，分别是柱状图区块、平均摄入量区块、摄入总量区块；要求能按照周、月、年的筛选来观察数据；三个区块的显示数据的范围是同步的；平均摄入量区块和摄入总量区块要显示四个数据（热量、碳、蛋、脂）；柱状图在周的筛选下时，显示的是七天的每天的总数据，柱状图在月的筛选下时，显示的是四个周的每周的总数据，柱状图在周的筛选下时，显示的是七天的数据
================================================================================
                              Git 版本控制操作指南
================================================================================
