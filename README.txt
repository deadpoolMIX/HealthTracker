...
43、问题：在"添加摄入"页面，点击"保存记录"后，回到了初始的"添加摄入"页面（就是没有食物记录的情况），虽然食物正常记录了，但是我需要点击以后直接回到首页。
44、问题：首页的食物、"添加摄入"页面中食物库的食物，都没有食物图标，图标位置显示的是英文，但是食物库中的食物，图标正常。
45、问题：点击首页食物，弹出修改窗口，窗口中的加餐选项大小与其它餐次不一样。需要统一大小、样式。
46、"添加自定义食物"页面，的"每百克营养数据"要修改，需要实现的功能是，可以设置每n克，单位也要不止克，要加上毫升的选项。计算也要跟着"每n克"的n随之计算。然后将该页面下的"设置单位"下的数值输入框中的"数值"二字改为"克/毫升"
47、
================================================================================
                              Git 版本控制操作指南
================================================================================
