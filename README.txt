...
81、“数据报表”页面选择周时，“营养素摄入”区块应该显示的是最近七天的柱状图，并且与x轴每一天的日期要对齐；“睡眠记录”区块的x轴是日期，y轴是时间，这个柱状图应该是竖着的。在选择月时，“营养素摄入”区块里应显示最近四周的四个柱状图（一个柱状图代表一周的总营养素摄入），x轴显示的应该是第1周、第2周、第3周、第4周，并且与柱状图对齐；“睡眠记录”区块应当显示四个柱状图，这四个柱状图分别是由这四周每一周的平均入睡时间、平均起床时间构成，x轴显示的应该是第1周、第2周、第3周、第4周，并且与柱状图对齐
82、
================================================================================
                              Git 版本控制操作指南
================================================================================
