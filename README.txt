...
36、首页添加的食物图标和食物库中的相同食物的图标不一致，应该是用的食物库中的图标才对。
37、问题："食物管理"页面，点击右边字母Y、Z这种最后面的字母时，左侧食物列表没有对应跳转到位置，（比如我点z,最多只能显示到Y字母的食物），应该是，y字母类下的食物显示在搜索框以下页面的最上方才对。
38、重写"开发者选项"--"生成测试数据"这个功能，要求生成最近一周的所有数据（摄入、体重、睡眠）
================================================================================
                              Git 版本控制操作指南
================================================================================
